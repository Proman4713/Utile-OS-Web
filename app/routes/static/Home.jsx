...
import { faCoffee, faDownload, faLegal, faShieldHalved } from "@fortawesome/free-solid-svg-icons";
import Footer from "../../components/UI/Footer";

function ScreenshotFrame({ src, alt, initial, whileInView, transition, viewport }) {
	...
	return (
		<motion.img
			src={src}
			height={594}
			style={{ borderRadius: 15, borderWidth: 10, borderStyle: "solid", borderColor: colours.monochromatic, boxSizing: "border-box", objectFit: "none", objectPosition: "top left", boxShadow: "0 5px 15px black" }}
			alt={alt}
	...
	return (
		<>
			...
			<Section noGap slow divide={false}>
				<motion.div
					id="latest-news"
					// onClick={() => window.open("https://blog.utile-os.com", "_blank")}
				>
					<I18NText mode="subtext" style={{ fontSize: "0.95em", letterSpacing: "0.5px", fontWeight: 400 }}>Snapshot <b>26-26w20g</b> is released</I18NText>
				</motion.div>
				<motion.div className="flex justify-center align-center">
					<svg width="922.5" viewBox="0 0 10250 3600" fill="none" xmlns="http://www.w3.org/2000/svg">
						<UtileDrawOn />
					...
					<svg width="283.14" viewBox="0 0 3146 2169" style={{ marginLeft: 30 }} fill="none" xmlns="http://www.w3.org/2000/svg">
						<motion.path
				...
				<I18NText className="homepage-text subtitle" style={{ fontSize: 40, color: colours.grey }}>homepage_tagline</I18NText>
			</Section>
			<Section>
			...
			<Footer
				paragraphs={["experimental_only", "supported_archs", "support_us", "made_with_passion"]}
				socials={[
